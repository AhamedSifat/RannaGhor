  ...
  return (
    <div>
      ...
      <div className='space-y-3'>
        <button className='w-full flex items-center justify-center gap-2 p-3 bg-[#E23774] text-white rounded-xl font-semibold hover:bg-[#c02667] transition-colors shadow-md shadow-rose-200'>
